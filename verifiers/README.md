...
| Item | Where |
|---|---|
| Identity card (learner id, checkpoint id, artifact version, teach lineage) | `learner-*/IDENTITY_CARD.md` |
...
| The harness identity and task configurations | [`battery/PROTOCOL.md`](battery/PROTOCOL.md) — stock `lm-evaluation-harness`, unmodified |
