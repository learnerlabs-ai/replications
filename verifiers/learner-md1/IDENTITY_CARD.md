...
| Identity verified | a live production ask returned `served_by: learner-1.0:lrn_a30df3e1e2b2` with `checkpoint_binding: learner_live` and these exact ids in the envelope |
