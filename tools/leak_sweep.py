...
WORDS = {
    # [2026-08-27 tightened secrecy rule] frozen-base / warm-up / domain-blind now forbidden
    "frozen-base": r"frozen[ -]?base",
    "warm-up":     r"warm[ -]?up",
    "domain-blind": r"domain[ -]?blind",
...
ALLOW = [
    ...
    # Added 2026-08-27 with demos/thinking-mode/. Both are the MODEL'S OWN words inside a published
    # thinking trace, about the invented company the model was taught, and both traces are quoted
    # in full on purpose. Narrowed to the exact phrase so the bare words still fail everywhere else.
    ("service tier", "published thinking trace: a commercial plan the model listed while reasoning "
